//
//  main-sample.cpp
//  just sample the domain for coverage and placement points
//
//
...
#pragma region Main:
  ...
  std::cout << std::endl << "Diskcover-sample: creating domain sample points for coverage and placement - only." << std::endl;
  ...
  double _delta = _epsilon *2.; // _epsilon * 4.;
